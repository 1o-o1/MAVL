...
- Results saved to results_full_scale_ablation_fast/
...
4. Line 42: RESULTS_DIR changed to "results_full_scale_ablation_fast"
...
RESULTS_DIR = ROOT_DIR / "results_full_scale_ablation_fast"  # CHANGED
